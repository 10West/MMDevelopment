...
function showStyleManager() {
	var win = new Ext.Window({
		...
		items: [{
				...
				xtype: "box",
				margin: 9,
				html: "The style sheet controls the default appearence of items  in the model. Select an item and choose 'Use as Default Style' to add its current styling to the style sheet. Properties like font, font size, and background color will be copied to other items of the same type. You can  download style sheets for sharing or reuse."
			}, {
				xtype: "container",
				layout: {
					type: 'hbox',
